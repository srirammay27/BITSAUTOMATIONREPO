...
public class Faculty_Suggest_Station_List_Objects {
	...
	public static WebElement btnCloseDelete;
	
	@FindBy(xpath="//*[@id=\"modal\"]/div/div/div[3]/button[2]")
	public static WebElement btnOkayDelete;
	...
	@FindBy(xpath="/html/body/app-root/app-layout/app-manage-station/div/div[2]/div/div[3]/table/tbody/tr/td[2]/a")
	public static WebElement grdColStation;
	
	@FindBy(xpath="/html/body/app-root/app-layout/app-manage-station/div/div[2]/div/div[3]/table/tbody/tr/td[7]")
	public static WebElement grdColStatus;
